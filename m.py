...
bot = telebot.TeleBot('7210102495:AAFjx4zi-oEQ9_QthW_fNe7AbubQw-qgEVI')
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in attack_cooldown and (datetime.datetime.now() - attack_cooldown[user_id]).seconds < 300:
...
def welcome_start(message):
    ...
    response = f"WELCOME TO KRISHNA PAID DDOS BOT JOIN:-https://t.me/+mT8MbcZr7EAxMjA1"
    bot.reply_to(message, response)
